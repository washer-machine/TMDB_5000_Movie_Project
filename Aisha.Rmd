...
mov %>% group_by(main_production) %>% 
  ...
  ylab('Average Budget(red) & Revenue(black)') +
  coord_flip()
```
...
sub$sub <- factor(sub$sub, levels = c('High', 'Average', 'Low'))
```
